...
It facilitates using without programming skills. The user can input protein sequences and receive the prediction results via email. The PSSMs of all proteins in the testing datasets as well as the human proteome are pre-computed on the server, so they are relatively faster.
}
\begin{table}[H]
  \centering
...
\section*{Funding}
The research of L.I. is funded by a Discovery Grant (R3143A01) and a Research Tools and Instruments Grant (R3143A07) from the Natural Sciences and Engineering Research Council of Canada. \textcolor{\mySecondColor}{++++ Brian's funding ++++}
