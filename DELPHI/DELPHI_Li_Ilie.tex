...
\textcolor{\mySecondColor}{Brian Golding\,$^2$}
 and Lucian Ilie\,$^{1,*}$}
...
\textbf{Availability:} \textcolor{\mySecondColor}{ The DELPHI web server, datasets, and results of in this study are freely available at\\ \texttt{https://www.csd.uwo.ca/\textasciitilde{}yli922/index.php}.\\
